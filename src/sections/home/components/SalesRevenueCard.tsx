  ...
  return (
    ...
    >
      ...
      <Grid container spacing={3} sx={{ alignItems: 'center' }}>
        {/* Mini Bars Chart (Month Comparison) */}
        ...
        <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
          ...
          >
            ...
            <Stack direction="row" spacing={0.75} sx={{ alignItems: 'baseline', my: 0.5 }}>
              <Typography
                variant="h4"
            ...
            <Stack direction="row" spacing={0.5} sx={{ alignItems: 'center', color: '#D97706' }}>
