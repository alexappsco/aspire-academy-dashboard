...
export const MOCK_COURSE_DETAILS = {
  id: '1',
  title_ar: 'أساسيات أمراض القلب والأوعية الدموية',
  title_en: 'Cardiovascular Basics & Medicine',
  specialty_ar: 'أمراض القلب',
  specialty_en: 'Cardiology',
  lecturer_ar: 'د. أحمد محمد',
  lecturer_en: 'Dr. Ahmed Mohamed',
  ...
  duration: '2س 45د',
  price: '45.50 ج.م',
  publishDate_ar: '20 أغسطس 2026',
  publishDate_en: '20 August 2026',
  imageUrl: '/images/cardiology-course.png',
  totalStudents: '8,543',
  studentsGrowth: '+12.5%',
  completionRate: 72,
  avgRating: '4.8 / 5',
  totalRevenue: '389,207 د.ك',
  description_ar:
    'نظرة شاملة على أمراض القلب والأوعية الدموية مصممة لطلاب الطب والأطباء المقيمين المبتدئين. يغطي هذا الكورس الفيزيولوجيا المرضية، وطرائق التشخيص، واستراتيجيات الإدارة المعاصرة لحالات القلب الشائعة والمعقدة.',
  description_en:
    'Comprehensive overview of cardiovascular medicine designed for medical students and junior resident physicians. Covers pathophysiology, diagnostic modalities, and contemporary management strategies for common and complex cardiac conditions.',
  chaptersCount: 4,
  videosCount: 24,
  quizzesCount: 8,
  resourcesCount: 12,
  ...
  recentReviews: [
    {
      ...
      avatarUrl: '',
      rating: 5,
      comment: 'تحليل ممتاز لقراءات تخطيط القلب، موصى به بشدة لطلاب السنة الثانية.',
    },
    {
      id: 'rev-2',
      name: 'David T.',
      avatarUrl: '',
      rating: 5,
      comment: 'محتوى جيد جداً، لكن كنت أتمنى لو كان قسم علم الأدوية أطول قليلاً.',
    },
  ],
};
