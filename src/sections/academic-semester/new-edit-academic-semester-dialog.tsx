...
import type { AcademicSemesterFormValues, AcademicSemesterItem } from '@/types/semester';

interface AcademicSemesterFormDialogProps {
  open: boolean;
  onClose: () => void;
  initialData?: AcademicSemesterItem | null;
  loading?: boolean;
  onSave: (data: AcademicSemesterFormValues) => void | Promise<void>;
}

export default function AcademicSemesterFormDialog({
  open,
  onClose,
  initialData,
  loading = false,
  onSave,
}: AcademicSemesterFormDialogProps) {
