  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ pt: 1, pb: 3, px: 3 }}>
        <Typography variant="h6" sx={{ fontWeight: 700, color: '#1E293B', mb: 2, fontSize: 20 }}>
        ...
        <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center' }}>
          <Button
            ...
            sx={{
              bgcolor: '#D32F2F', color: '#FFFFFF', borderRadius: 1.5, px: 4, py: 1,
              fontWeight: 600, fontSize: 15, minWidth: 100, boxShadow: 'none',
          ...
          <Button
            ...
            onClick={onClose}
            sx={{
              borderColor: '#E2E8F0', color: '#1E293B', borderRadius: 1.5, px: 4, py: 1,
              fontWeight: 600, fontSize: 15, minWidth: 100,
